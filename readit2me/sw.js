...
self.addEventListener('fetch', (event) => {
  ...
  // Only handle same-origin GETs inside our scope; everything else (Firebase,
  // gstatic SDK, Storage downloads) goes to the network untouched.
